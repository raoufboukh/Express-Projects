    ...
    <>
      <footer className="my-20">
        <div className="container mx-auto px-4 lg:px-20">
          <div className="flex justify-center flex-wrap md:gap-0 gap-8 ml-40">
            ...
            <div className="lg:basis-1/3 md:basis-1/2 basis-full text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start gap-3 mt-2">
                <a href="https://facebook.com" className="hover:opacity-75 transition">
                  <Image src="/assets/home_clinic3_pic6.png" alt="Facebook" width={24} height={24} className="w-6 h-6" />
                </a>
                <a href="https://whatsapp.com" className="hover:opacity-75 transition">
                  <Image src="/assets/home_clinic3_pic24.png" alt="WhatsApp" width={24} height={24} className="w-6 h-6" />
                </a>
                <a href="https://linkedin.com" className="hover:opacity-75 transition">
                  <Image src="/assets/home_clinic3_pic25.png" alt="LinkedIn" width={24} height={24} className="w-6 h-6" />
                </a>
                <a href="https://instagram.com" className="hover:opacity-75 transition">
                  <Image src="/assets/home_clinic3_pic23.png" alt="Instagram" width={24} height={24} className="w-6 h-6" />
                </a>
              </div>
            </div>
