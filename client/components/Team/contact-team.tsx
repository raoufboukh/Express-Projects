  ...
  return (
    <div className="bg-secondary py-20 md:py-32 px-4 my-28">
      <div className="sm:w-[600px] mx-auto text-center">
        <h4 className="text-gray-300 text-xl tracking-wider">
        Get in Touch with Our Experts
        </h4>
        <h3 className="text-white text-4xl sm:text-5xl font-bold my-5">
        Need Medical Imaging Assistance ?
        </h3>
        <p className="text-gray-400">
          Our specialized team provides high-quality imaging services, ensuring 
