...
import { bookAppointment, check } from "@/lib/dataFetching";
...
const BookApp = () => {
  ...
  return (
    <div className="text-white">
      ...
      {user.appointments && user?.appointments[0]?.date && <p>You are booking at {user.appointments[0].date.slice(0,10)}</p>}
    </div>
  );
}
